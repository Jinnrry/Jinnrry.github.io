...
var _markdown = __webpack_require__(41);
...
var _vueScroll = __webpack_require__(47);

var _vueScroll2 = _interopRequireDefault(_vueScroll);

var _highlightMin = __webpack_require__(49);

var _highlightMin2 = _interopRequireDefault(_highlightMin);

var _rangeFn = __webpack_require__(50);
...
_marked2.default.setOptions({
    ...
    highlight: function highlight(code) {
        return _highlightMin2.default.highlightAuto(code).value;
    }
});
...
exports.default = {
    ...
    methods: {
        ...
        addCode: function addCode() {
            ...
            insertContent('```\n\n```', this);
            if (lastChart != '\n' && value != '') {
                _rangeFn2.default.setCaretPosition(textareaDom, point + 5);
            } else {
                _rangeFn2.default.setCaretPosition(textareaDom, point + 4);
            }
        },
        addStrikethrough: function addStrikethrough() {
            ...
            insertContent('~~~~', this);
            if (lastChart != '\n' && value != '') {
                _rangeFn2.default.setCaretPosition(textareaDom, point + 3);
            } else {
                _rangeFn2.default.setCaretPosition(textareaDom, point + 2);
            }
        },
        ...
        addItalic: function addItalic() {
            ...
            if (lastChart != '\n' && value != '') {
                ...
                _rangeFn2.default.setCaretPosition(textareaDom, point + 1);
            }
        },
    ...
    watch: {
        input: function input() {
            ...
            data.htmlValue = (0, _marked2.default)(this.input, {
                sanitize: true
            });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("预览生成文件")]), _vm._v(" "), _c('div', {
    staticClass: "btn",
    on: {
      "click": _vm.saveFile
    }
  }, [_vm._v("下载文章")]), _vm._v(" "), _c('router-link', {
    staticClass: "btn btn-default",
    attrs: {
      "to": "/"
    }
  }, [_vm._v("返回")])], 1), _vm._v(" "), (_vm.dilogStatus) ? _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('h2', [_vm._v("Jekyll Editor 博文编辑器")]), _vm._v(" "), _c('div', [_vm._v("下面请填写Jekyll博文头部信息")]), _vm._v(" "), _c('form', {
    attrs: {
      "action": "",
      "method": "get"
    }
    ...
    staticClass: "btn btn-submit btn-default ",
    attrs: {
      "to": {
        path: 'index',
        query: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("JekyllEditor")]) : _vm._e(), _vm._v(" "), _c('div', {
...
//# sourceMappingURL=app.e8266a6a4cd094310564.js.map